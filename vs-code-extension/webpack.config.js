...
const extensionConfig = {
  ...
  plugins: [
    new CopyPlugin({
      patterns: [
        {
          from: path.resolve(__dirname, 'agent_server.py'),
          to: path.resolve(__dirname, 'dist', 'agent_server.py')
        },
        {
          from: path.resolve(__dirname, 'agent.yaml'),
          to: path.resolve(__dirname, 'dist', 'agent.yaml')
        }
      ]
    })
  ],
